...
export const puzzlePiece_data: BezierShape = {
  origin: [54.46, 0],
  vertices: [
    [54.46, 0, 37.27, 0, 37.27, 0],             // line to (37.27, 0)
    [31.55, 0, 26.91, 4.64, 26.91, 10.36],
    [26.91, 10.36, 26.91, 10.51, 26.91, 10.51], // line to (26.91, 10.51)
    [26.91, 15.17, 23.13, 18.96, 18.46, 18.96],
    [18.46, 18.96, 10.36, 18.96, 10.36, 18.96], // line to (10.36, 18.96)
    [4.64, 18.96, 0, 23.60, 0, 29.32],
    [0, 29.32, 0, 54.46, 0, 54.46],             // line to (0, 54.46)
    [0, 60.18, 4.64, 64.82, 10.36, 64.82],
    [10.36, 64.82, 35.50, 64.82, 35.50, 64.82], // line to (35.50, 64.82)
    [41.22, 64.82, 45.86, 60.18, 45.86, 54.46],
    [45.86, 54.46, 45.86, 46.36, 45.86, 46.36], // line to (45.86, 46.36)
    [45.86, 41.70, 49.64, 37.91, 54.31, 37.91],
    [54.31, 37.91, 54.46, 37.91, 54.46, 37.91], // line to (54.46, 37.91)
    [60.18, 37.91, 64.82, 33.27, 64.82, 27.55],
    [64.82, 27.55, 64.82, 10.36, 64.82, 10.36], // line to (64.82, 10.36)
    [64.82, 4.64, 60.18, 0, 54.46, 0],
  ],
  color: 'gold',
}
