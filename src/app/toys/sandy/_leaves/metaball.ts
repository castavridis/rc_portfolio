...
export const metaball_data: BezierShape = {
  origin: [63.8, 49.79],
  vertices: [
    [75.06, 47.72, 83.96, 38.17, 84.42, 26.52],
    [85.01, 11.19, 73.7, -0.16, 58.37, 0.53],
    [46.13, 1.08, 34.86, 9.83, 34.58, 22.48],
    [34.54, 24.17, 33.16, 25.48, 31.47, 25.40],
    [31.00, 25.38, 30.52, 25.37, 30.05, 25.37],
    [13.1, 25.36, -0.51, 39.62, 0.56, 56.79],
    [1.47, 71.50, 13.45, 83.48, 28.16, 84.39],
    [45.33, 85.46, 59.59, 71.84, 59.59, 54.90],
    [59.59, 54.88, 59.59, 54.87, 59.59, 54.85],
    [59.59, 52.35, 61.34, 50.24, 63.80, 49.78],
  ],
  color: 'purple',
}
