...
const s = (sketch: p5) => {
  ...
  function setMode () {
    updateCurve()
    // Currently DCPOINT is the final point necessary to complete the bezier
    if (currMode === MODE.DCPOINT) {
      currCurve++
    }
